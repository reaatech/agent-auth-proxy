...
export async function buildApp() {
  ...
  const httpRequestsTotal = register.getSingleMetric('http_requests_total') as Counter<string>
    || new Counter({
  ...
  const httpRequestDuration = register.getSingleMetric('http_request_duration_seconds') as Histogram<string>
    || new Histogram({
...
const isDirectLaunch = scriptPath && !scriptPath.includes('node_modules');
if (isDirectLaunch) {
  void main();
}
